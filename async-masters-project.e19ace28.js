var t=globalThis,e={},r={},s=t.parcelRequire6801;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in r){var s=r[t];delete r[t];var c={id:t,exports:{}};return e[t]=c,s.call(c.exports,c,c.exports),c.exports}var a=Error("Cannot find module '"+t+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(t,e){r[t]=e},t.parcelRequire6801=s);var c=s.register;c("7xXel",function(t,e){var r=s("4T1Q4");Object.keys(localStorage).includes("cart")||localStorage.setItem("cart",JSON.stringify([])),document.querySelector("body").addEventListener("click",async t=>{if(!("true"===t.target.dataset.productadd||t.target.closest("[data-productadd]")||"true"===t.target.dataset.productclose||t.target.closest('[data-productclose="true"]')||"count"===t.target.dataset.cart||t.target.closest("[data-cart='count']"))&&("true"===t.target.dataset.product||t.target.closest("[data-product]"))){let e;document.querySelector("#product-backdrop").classList.remove("is-hidden"),document.querySelector("body").classList.add("no-scroll"),e=""!==t.target.id?t.target.id:t.target.closest("[data-product]").id,await (0,r.getProduct)(e).then(({_id:t,name:e,img:r,category:s,price:c,size:a,desc:o,is10PercentOff:i,popularity:d})=>{document.querySelector("[data-productmodal]").id=t,document.querySelector("#product-img").src=r,document.querySelector("#product-img").alt=e,document.querySelector("#product-name").textContent=e,document.querySelector("#product-category").textContent=s,document.querySelector("#product-size").textContent=a,document.querySelector("#product-popularity").textContent=d,document.querySelector("#product-price").textContent=c,document.querySelector("#product-desc").textContent=o,document.querySelector("#product-add").innerHTML=JSON.parse(localStorage.getItem("cart")).map(t=>t.id).includes(t)?`Added \u{2713}`:`Add to <svg class="product__icon" width="18" height="18">
  ...
  <svg class="products__discount" width="60" height="60">
    ...
    `).join("")}),l.addEventListener("click",t=>{let e=t.target.closest(".add-to-cart-btn");if(!e)return;let r=e.querySelector("use");r&&"#cart"===r.getAttribute("href")&&r.setAttribute("href","#check")}),(async()=>{try{return await fetch("https://food-boutique.b.goit.study/api/products/popular").then(t=>t.json())}catch(t){return t}})().then(t=>{document.querySelector("#popular__list").innerHTML=t.map(({_id:t,name:e,img:r,category:s,size:c,is10PercentOff:a,popularity:o})=>`<li id='${t}' data-product='true' class="popular__item">
    ...
    <svg class="popular__icon" width="12" height="12">
      <use href="#cart"></use>
          ...
          `;document.querySelector(".discount__list").innerHTML=e});let u=1;const p=(t,e,r,s)=>{a(r,e,t,s).then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:a,is10PercentOff:o,popularity:i})=>`<li id="${t}" data-product="true" class="products__item">
        ${o?`<div class="products__green">
  <svg class="products__discount" width="54" height="54">
    <use href="#discount"></use>
            ...
            </li>`).join("")})},g=(t,e,r,s)=>{a(r,e,t,s).then(({totalPages:e})=>{let r="";for(let s=t;s<=e&&s<=t+3;s+=1)r+=`<li id='${s}' class="pagination__item ${t===s?"pagination__accent":""}">
...
//# sourceMappingURL=async-masters-project.e19ace28.js.map
