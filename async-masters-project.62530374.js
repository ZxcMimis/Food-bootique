  ...
  <svg class="products__discount" width="60" height="60">
    ...
    <svg class="popular__icon" width="12" height="12">
      <use href="#cart"></use>
          ...
          `;document.querySelector(".discount__list").innerHTML=e});let l=1;const u=(t,e,r,s)=>{a(r,e,t,s).then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:a,is10PercentOff:o,popularity:i})=>`<li id="${t}" data-product="true" class="products__item">
        ${o?`<div class="products__green">
