var t=globalThis,e={},r={},s=t.parcelRequire6801;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in r){var s=r[t];delete r[t];var c={id:t,exports:{}};return e[t]=c,s.call(c.exports,c,c.exports),c.exports}var a=Error("Cannot find module '"+t+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(t,e){r[t]=e},t.parcelRequire6801=s);var c=s.register;c("7xXel",function(t,e){var r=s("4T1Q4");function c(){document.querySelector("#product-backdrop").classList.add("is-hidden"),document.querySelector("[data-productmodal]").id="",document.querySelector("body").classList.remove("no-scroll"),document.querySelector("#product-img").src="",document.querySelector("#product-img").alt="",document.querySelector("#product-name").textContent="",document.querySelector("#product-category").textContent="",document.querySelector("#product-size").textContent="",document.querySelector("#product-popularity").textContent="",document.querySelector("#product-price").textContent="",document.querySelector("#product-desc").textContent=""}Object.keys(localStorage).includes("cart")||localStorage.setItem("cart",JSON.stringify([])),document.querySelector("#header-cart").textContent=JSON.parse(localStorage.getItem("cart")).length,document.querySelector("body").addEventListener("click",async t=>{if(!("true"===t.target.dataset.productadd||t.target.closest("[data-productadd]")||"true"===t.target.dataset.productclose||t.target.closest('[data-productclose="true"]')||"count"===t.target.dataset.cart||t.target.closest("[data-cart='count']"))&&("true"===t.target.dataset.product||t.target.closest("[data-product]"))){let e;document.querySelector("#product-backdrop").classList.remove("is-hidden"),document.querySelector("body").classList.add("no-scroll"),e=""!==t.target.id?t.target.id:t.target.closest("[data-product]").id,await (0,r.getProduct)(e).then(({_id:t,name:e,img:r,category:s,price:c,size:a,desc:o,is10PercentOff:i,popularity:d})=>{document.querySelector("[data-productmodal]").id=t,document.querySelector("#product-img").src=r,document.querySelector("#product-img").alt=e,document.querySelector("#product-name").textContent=e,document.querySelector("#product-category").textContent=s,document.querySelector("#product-size").textContent=a,document.querySelector("#product-popularity").textContent=d,document.querySelector("#product-price").textContent=c,document.querySelector("#product-desc").textContent=o,document.querySelector("#product-add").innerHTML=JSON.parse(localStorage.getItem("cart")).map(t=>t.id).includes(t)?`Remove from <svg class="product__icon" width="18" height="18">
...
</div>`,document.querySelector("#pagination-section").classList.add("display-none");return}document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:a,is10PercentOff:o,popularity:i})=>`<li id="${t}" data-product="true" class="products__item">
  ...
  <svg class="products__discount" width="60" height="60">
    <use href="#discount"></use>
            ...
            </li>`).join(""),document.querySelector("#pagination-section").classList.remove("display-none")})};document.querySelector("#filters-form").addEventListener("submit",t=>{t.preventDefault(),l(o=document.querySelector("#filters-input").value,i,1,d)}),document.querySelector("#filters-categories").addEventListener("click",t=>{t.currentTarget.nextElementSibling.classList.toggle("is-hidden"),t.currentTarget.querySelector("svg").classList.toggle("filters__rotated")}),document.querySelector("#filters-categories-list").addEventListener("click",t=>{t.currentTarget.querySelector(".filters__item--checked").classList.remove("filters__item--checked"),t.currentTarget.closest("ul").previousElementSibling.children[1].classList.toggle("filters__rotated"),t.target.classList.add("filters__item--checked"),t.currentTarget.classList.add("is-hidden"),document.querySelector("#filters-categories-text").textContent=t.target.textContent,i="all"===t.target.id?"":t.target.id,l(o,i,1,d)}),document.querySelector("#filters-alphabet").addEventListener("click",t=>{t.currentTarget.nextElementSibling.classList.toggle("is-hidden"),t.currentTarget.querySelector("svg").classList.toggle("filters__rotated")}),document.querySelector("#filters-alphabet-list").addEventListener("click",t=>{t.currentTarget.querySelector(".filters__item--checked").classList.remove("filters__item--checked"),t.currentTarget.closest("ul").previousElementSibling.children[1].classList.toggle("filters__rotated"),t.target.classList.add("filters__item--checked"),t.currentTarget.classList.add("is-hidden"),document.querySelector("#filters-alphabet-text").textContent=t.target.textContent,d="allAlphabet"===t.target.id?"":t.target.id,l(o,i,1,d)}),document.querySelector("body").addEventListener("click",t=>{t.target.closest("#filters-categories")||document.querySelector("#filters-categories-list").classList.contains("is-hidden")||(document.querySelector("#filters-categories-list").classList.add("is-hidden"),document.querySelector("#filters-categories").querySelector("svg").classList.remove("filters__rotated")),t.target.closest("#filters-alphabet")||document.querySelector("#filters-alphabet-list").classList.contains("is-hidden")||(document.querySelector("#filters-alphabet-list").classList.add("is-hidden"),document.querySelector("#filters-alphabet").querySelector("svg").classList.remove("filters__rotated"))}),document.querySelector("#products-list"),a("","",1,"").then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:a,is10PercentOff:o,popularity:i})=>`
...
${o?`<div class="products__green">
  <svg class="products__discount" width="60" height="60">
    ...
    <svg class="popular__icon" width="12" height="12">
      <use href="#cart"></use>
          ...
          `;document.querySelector(".discount__list").innerHTML=e});let n=1;const u=(t,e,r,s)=>{a(r,e,t,s).then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:a,is10PercentOff:o,popularity:i})=>`<li id="${t}" data-product="true" class="products__item">
        ${o?`<div class="products__green">
  <svg class="products__discount" width="54" height="54">
    <use href="#discount"></use>
      ...
      </li>`),document.querySelector("#pagination-list").innerHTML=r,t-2<1?document.querySelector("#double-prev").classList.add("pagination__disable"):document.querySelector("#double-prev").classList.remove("pagination__disable"),t-1<1?document.querySelector("#prev").classList.add("pagination__disable"):document.querySelector("#prev").classList.remove("pagination__disable"),t+2>e?document.querySelector("#double-next").classList.add("pagination__disable"):document.querySelector("#double-next").classList.remove("pagination__disable"),t+1>e?document.querySelector("#next").classList.add("pagination__disable"):document.querySelector("#next").classList.remove("pagination__disable")})};p(1,i,o,d),document.querySelector("#pagination-list").addEventListener("click",t=>{t.target.classList.contains("pagination__btn")&&Number.parseInt(t.target.parentElement.id)!==n&&(p(n=Number.parseInt(t.target.parentElement.id),i,o,d),u(n,i,o,d))}),document.querySelector("#next").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(p(n+=1,i,o,d),u(n,i,o,d))}),document.querySelector("#double-next").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(p(n+=2,i,o,d),u(n,i,o,d))}),document.querySelector("#prev").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(p(n-=1,i,o,d),u(n,i,o,d))}),document.querySelector("#double-prev").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(p(n-=2,i,o,d),u(n,i,o,d))}),document.querySelector("#filters-form").addEventListener("submit",t=>{p(n=1,i,o,d)}),document.querySelector("#filters-categories-list").addEventListener("click",t=>{p(n=1,i,o,d)}),document.querySelector("#filters-alphabet-list").addEventListener("click",t=>{p(n=1,i,o,d)}),s("7xXel"),s("1eDY5");
//# sourceMappingURL=async-masters-project.3fa9e0b5.js.map
