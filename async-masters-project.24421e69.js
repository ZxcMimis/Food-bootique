const t=async()=>{try{return await fetch("https://food-boutique.b.goit.study/api/products/popular").then(t=>t.json())}catch(t){return t}};t().then(t=>{document.querySelector("#popular__list").innerHTML=t.map(({_id:t,name:e,img:r,category:s,size:c,is10PercentOff:o,popularity:a})=>`<li id='${t}' class="popular__item">
      ...
      </li>`).join("")});const e=async(t,e,r,s)=>{try{return await fetch(`https://food-boutique.b.goit.study/api/products?keyword=${t}${s}&category=${e}&page=${r}&limit=9`).then(t=>t.json())}catch(t){return t}};let r="",s="",c="";const o=(t,r,s,c)=>{if(r.includes("&")){document.querySelector("#products-list").innerHTML=`<div class="products__nocards">
...
</div>`;return}e(t,r,s,c).then(t=>{if(0===t.results.length){document.querySelector("#products-list").innerHTML=`<div class="products__nocards">
  <h3 class="products__notitle">
...
</div>`;return}document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:o,is10PercentOff:a,popularity:i})=>`
