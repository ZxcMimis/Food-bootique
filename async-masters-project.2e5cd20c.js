  ...
  <p class="products__nodesc">
...
</div>`,document.querySelector("#pagination-section").classList.add("display-none");return}document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:a,is10PercentOff:o,popularity:i})=>`<li id="${t}" class="products__item">
    ...
    <svg class="popular__icon" width="12" height="12">
      <use href="#cart"></use>
          ...
          `;document.querySelector(".discount__list").innerHTML=e});let l=1;const u=(t,e,r,s)=>{a(r,e,t,s).then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:s,size:c,price:a,is10PercentOff:o,popularity:i})=>`<li id="${t}" class="products__item">
                <div class="products__container_img">
                    <img src="${r}" alt="${e}" class="products__img">
                </div>
                <h2 class="products__title">Avocado</h2>
...
//# sourceMappingURL=async-masters-project.2e5cd20c.js.map
