const t=async()=>{try{return await fetch("https://food-boutique.b.goit.study/api/products/popular").then(t=>t.json())}catch(t){return t}};t().then(t=>{document.querySelector("#popular__list").innerHTML=t.map(({_id:t,name:e,img:o,category:r,size:a,is10PercentOff:c,popularity:s})=>`<li id='${t}' class="popular__item">
      ...
      </li>`).join("")}),(async(t,e,o)=>{console.log(t);try{if(t)return await fetch(`https://food-boutique.b.goit.study/api/products?category=${e}&page=${1}&limit=9`).then(t=>t);if(e)return console.log("eee"),await fetch(`https://food-boutique.b.goit.study/api/products?keyword=${t}&page=${o}&limit=9`).then(t=>t);return await fetch(`https://food-boutique.b.goit.study/api/products?keyword=${t}&category=${e}&page=${o}&limit=9`).then(t=>t)}catch(t){return t}})("Ackee","Fresh Produce",1).then(t=>{console.log(t)}),t().then(t=>{document.querySelector("#popular__list").innerHTML=t.map(({_id:t,name:e,img:o,category:r,size:a,is10PercentOff:c,popularity:s})=>`<li id='${t}' data-product='true' class="popular__item">
        <div class="popular__wrapper">
          <img src="${o}" alt="${e}" class="popular__img" />
        </div>
        <div class="popular__text">
...
//# sourceMappingURL=async-masters-project.ff381b25.js.map
