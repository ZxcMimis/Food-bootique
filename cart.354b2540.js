    ...
    <div class="cart__nobody">
      <picture>
        ...
        <img
          ...
          width="164"
          height="140"
          src="./img/phone/x1/basket@1x.webp"
          alt="Basket"
        />
      </picture>
      <h3 class="cart__notitle">
        Your basket is <span class="cart__nospan">empty...</span>
      </h3>
      <p class="cart__nodesc">
        Go to the main page to select your favorite products and add them to the
        cart.
      </p>
    </div>`;return}JSON.parse(localStorage.getItem("cart")).forEach(async t=>{await (0,o.getProduct)(t.id).then(({_id:t,img:e,name:a,category:r,size:c,price:o})=>{document.getElementById("cart-list").insertAdjacentHTML("beforeend",`<li id="${t}" data-product="true" class="cart__item">
...
//# sourceMappingURL=cart.354b2540.js.map
