  ...
  <p class="products__nodesc">
...
</div>`,document.querySelector("#pagination-section").classList.add("display-none");return}document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:a,size:c,price:s,is10PercentOff:o,popularity:d})=>`
    ...
    <svg class="aa" width="12" height="12">
      <use href="#cart"></use>
          ...
          `;document.querySelector(".discount__list").innerHTML=e});let l=1;const u=(t,e,r,a)=>{s(r,e,t,a).then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:r,category:a,size:c,price:s,is10PercentOff:o,popularity:d})=>`<li id="${t}" data-product="true" class="products__item">
        <div class="products__container_img">
            <img src="${r}" alt="Carrots" class="products__img">
        </div>
        <h2 class="products__title">${e}</h2>
